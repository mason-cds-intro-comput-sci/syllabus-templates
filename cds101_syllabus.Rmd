...
LMS <- "Canvas" # change to Blackboard if relevant

stars <- c("Bharathi Balamurugan") # List STARS names here.
# EXAMPLE:
# stars <- c("Joe Bloggs")
...
holidays <- c(
  "Spring Recess (Mon. Mar 10 - Sun. Mar 16)"
)
...
* Major infraction (e.g. cheating in an exam, or copying from another student’s assignment/project, or submitting an AI generated assignment):
