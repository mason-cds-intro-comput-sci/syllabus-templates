...
instructor_office <- "Research Hall 242"
...
is_in_person <- TRUE
classroom <- "Innovation Hall 137"
meeting_times <- "Mondays and Wednesdays at 1:30pm"

holidays <- c(
  "Labor Day (Mon. Sept 4)",
  "Fall Break (Mon. Oct 9 - Monday classes will be held on Tues. Oct 10)",
  "Thanksgiving Recess (Wed. Nov 22 - Sun. Nov 26)"
)

is_summer_session <- FALSE
```
