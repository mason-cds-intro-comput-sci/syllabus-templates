...
stars <- c("Samantha Lawrence") # List STARS names here.
# EXAMPLE:
# stars <- c("Joe Bloggs")
...
**Who:** This section of CDS 101 is taught by `r instructor`, `r instructor_title` `r instructor_affiliation` (email: `r instructor_email`). Your section also has the following STARs (teaching assistants): `r paste(stars, sep=", ")`. Office hours are posted on Blackboard.
...
2. There will be a short Blackboard quiz on those preparatory materials.
...
A provisional calendar for the course modules will be made available on Blackboard. Timings of different modules may be changed subject to our progress throughout the semester.
