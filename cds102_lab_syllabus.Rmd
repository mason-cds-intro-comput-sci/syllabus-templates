---
subtitle: "Introduction to Computational and Data Sciences labs"
...
meeting_times <- "Mondays at 1:30pm"
```

---
title: "`r 'CDS 102 Syllabus'` (`r semester` `r year`, Section `r section_number`)"
---
...
**Who:** This section of CDS 102 is taught by `r instructor`, `r instructor_title` `r instructor_affiliation` (email: `r instructor_email`). Your section also has the following STARs (teaching assistants): `r paste(stars, sep=", ")`. Office hours are posted on `r LMS`.
...
2. **Q&A discussion on Canvas:** This is the preferred place to ask course-related questions outside of office hours. If you have a question or comment about the materials or coursework, please post it in the Q&A discussion board in Canvas. There is a single Q&A board for all coursework.

   Examples of what the Canvas Q&A board is appropriate for:
   ...
   * Troubleshooting errors with your code.
   ...
   The Q&A board is public, so do not use it for personal information such as extension requests. Instead...
...
4. **Email:** Use email for anything that doesn't fit the categories above, e.g. sending an Academic Accommodation Letter to your instructor, or some other type of communication containing information that should not be posted publicly in the Canvas Q&A. 
...
* Email response policy: If you email me about an issue that would be better asked via the Canvas Q&A or Incident Report, then I will ask you to resubmit it in one of those locations.
...
Other violations of Mason’s Honor Code will be treated similarly. Suspected violations will be reported to Academic Standards.
...
A provisional calendar for the labs will be made available on `r LMS`. Timings of different labs may be changed subject to our progress throughout the semester.
